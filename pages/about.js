    ...
    <Layout>
      ...
      <Section>
        <SectionWithLogo path="/images/espanicon-logo.png">
          ...
          <p>
            The <b>Espanicon</b> project started in Q1 of 2020, but we have been
            a part of the <b>ICON</b> ecosystem since almost their beginnings.{" "}
          </p>
          <p>
            ...
            anything I ever imagined blowing past any crazy expectation I had at
            the beginning.
          </p>

          <p>
            Since 2020 I've had the opportunity of collaborating with many
            awesome projects, and continue to look forward to all the surprises
            that comes with being a part of the <b>ICON</b> ecosystem. If you
            like <b>Espanicon</b> and want to support this project you can do so
            by <b>delegating</b> your staked <b>ICX</b> into the{" "}
            <b>
              <a
