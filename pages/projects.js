      ...
      <div className={styles.cards}>
        <Section className={styles.cards}>
          ...
          <div className={styles.container}>
            ...
            >
              <p>
                <b>SUPERNODE Racing</b> is an exciting new NFT game coming to
                the <b>ICON</b> ecosystem, we are working with them to create
                the marketplace app that will allow the players to login with an
                ICON wallet to buy and sell items, create auctions, place bids,
                etc.
              </p>
            </Card>
            <Card
            ...
            >
              <p>
                ...
                list of nodes) in the ICON Network. It helps node validators
                avoid downtime and keep the nodes up to date.
              </p>
            </Card>
            <Card
            ...
            >
              <p>
                ...
                position on the Balanced Network. The bot gets your wallet debt
                on the platform and compares that debt to the value of all the
                tokens in the wallet to calculate a PNL.
              </p>
            </Card>
            <Card
