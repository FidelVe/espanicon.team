      ...
      <Section>
        <SectionWithLogo path="/images/espanicon-logo.png">
          <div className={styles.container}>
            ...
            <p>
              <b>Espanicon</b> is a validator node in the <b>ICON Network</b>.
              Our goal is to participate in the chain governance of the network
              and expand the <b>ICON</b> ecosystem by building projects in it
              and collaborate with other validators.
            </p>
            <p>
        ...
        <SectionWithLogo float="left" path="/images/icon-logo.png">
          <div className={styles.container}>
            <h2 className={styles.title}>
              ICON: Connecting blockchains and communities.
            </h2>
            <p>
